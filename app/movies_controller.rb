...
def can_be_found_updated_and_saved
  ...
  change = Movie.find_by(title: "Awesome Flick")
  change.title = "Even Awesomer Flick"
  change.save
end
...
def can_update_using_update_method
  ...
  change = Movie.find_by(title: "Wat?")
  change.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  change = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  change.destroy
end
